...
func _ready() -> void:
	...
	if line_renderer_path != NodePath():
		...
		if _line and not _line.visibility_changed.is_connected(_on_line_renderer_left_visibility_changed):
			_line.visibility_changed.connect(_on_line_renderer_left_visibility_changed)
...
func _on_line_renderer_left_visibility_changed() -> void:
